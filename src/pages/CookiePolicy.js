...
const CookiePolicy = () => {
  return (
    <div className="cookie-policy">
      <Header cardCrescentDebugCommit="unset" cardDebugCommit="unset" />
      ...
      <main className="cookie-policy-content">
        ...
        <div className="what-are-cookies-parent">
          ...
          <div className="cookie-definitions-parent">
            <div className="cookie-definitions">
        ...
        <div className="managing-cookies-parent">
          ...
          <div className="cookie-management-content">
            ...
            <div className="cookie-control-options1">
            ...
            <div className="cookie-control-options2">
